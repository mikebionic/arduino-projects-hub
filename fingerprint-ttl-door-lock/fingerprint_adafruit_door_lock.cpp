...
int getFingerprintIDez() {
  ...
  if (p != FINGERPRINT_OK)  {return -1;}
     ...
     if (finger.fingerID==2){Serial.println ("Muhammed"); person ="Muhammed";}
     if (finger.fingerID==4){Serial.println ("Muhammed"); person ="Islam";}
     if (finger.fingerID==5){Serial.println ("Muhammed"); person ="Pena";}
     if (finger.fingerID==6){Serial.println ("Muhammed"); person ="Didar";}
     if (finger.fingerID==1){Serial.println ("Muhammed"); person ="Azat";}
